...
async function main() {
  ...
  // ── PlantLogistic Orders ──────────────────────────────────────────────

  console.log("\n📦 Seeding PlantLogistic orders...\n");
  ...
  const logisticOrders = [
    {
      ...
      vehicleVariant: "Low Entry",
      vehicleType: "BUS" as const,
      powertrain: "ELECTRIC" as const,
      quantity: 15,
      priority: "HIGH" as const,
      status: "SUBMITTED" as const,
      requestedDeliveryDate: new Date("2026-09-30"),
      salesOrderNo: "SO-2026-0451",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
    },
    {
      id: "lo-002",
      orderNumber: "LO-00002",
      customerName: "AutoBahn Dealers",
      customerType: "DEALER" as const,
      dealerName: "AutoBahn Dealers",
      country: "Germany",
      market: "EU",
      ...
      status: "APPROVED" as const,
      requestedDeliveryDate: new Date("2026-08-15"),
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
    ...
    {
      id: "lo-003",
      orderNumber: "LO-00003",
      customerName: "EcoMove Mobility",
      customerType: "DISTRIBUTOR" as const,
      distributorName: "EcoMove Mobility",
      country: "Netherlands",
      market: "EU",
      vehicleModel: "CityStar 9M",
      vehicleVariant: "Midibus Hybrid",
      vehicleType: "MIDIBUS" as const,
      powertrain: "HYBRID" as const,
      quantity: 10,
      priority: "NORMAL" as const,
      status: "PLANNED" as const,
      plannedProductionDate: new Date("2026-07-01"),
      plannedProductionWeek: "2026-W27",
      plannedDeliveryDate: new Date("2026-09-15"),
      productionOrderNo: "PO-2026-0112",
      requestNumber: "RFQ-2026-0088",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-qe",
    },
    {
      id: "lo-004",
      orderNumber: "LO-00004",
      customerName: "GreenFleet GmbH",
      customerType: "CUSTOMER" as const,
      country: "Germany",
      market: "EU",
      ...
      plannedProductionDate: new Date("2026-05-20"),
      plannedProductionWeek: "2026-W21",
      plannedDeliveryDate: new Date("2026-07-30"),
      productionOrderNo: "PO-2026-0098",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
    },
    {
      id: "lo-005",
      orderNumber: "LO-00005",
      customerName: "Iberia Bus Corp",
      customerType: "CUSTOMER" as const,
      country: "Spain",
      market: "EU",
      vehicleModel: "CityStar 12E",
      ...
      plannedProductionDate: new Date("2026-04-15"),
      plannedProductionWeek: "2026-W16",
      plannedDeliveryDate: new Date("2026-06-30"),
      productionOrderNo: "PO-2026-0075",
      vin: "WVGZZZ123ZS000501",
      chassisNumber: "CH-2026-0075-A",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-qe",
      notes: "Quality hold — paint defect identified on unit 1. Production paused until root cause confirmed.",
    },
    {
      id: "lo-006",
      orderNumber: "LO-00006",
      customerName: "MedTrans Ltd",
      customerType: "DEALER" as const,
      dealerName: "MedTrans Ltd",
      country: "Turkey",
      market: "MENA",
      ...
      plannedProductionDate: new Date("2026-04-01"),
      plannedProductionWeek: "2026-W14",
      plannedDeliveryDate: new Date("2026-05-10"),
      vin: "WVGZZZ456ZT000802",
      chassisNumber: "CH-2026-0080-B",
      productionOrderNo: "PO-2026-0060",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
    },
    {
      id: "lo-007",
      orderNumber: "LO-00007",
      customerName: "Nordic Trans AB",
      customerType: "DISTRIBUTOR" as const,
      distributorName: "Nordic Trans AB",
      country: "Sweden",
      market: "EU",
      vehicleModel: "CityStar 12E",
      vehicleVariant: "Arctic Package",
      vehicleType: "BUS" as const,
      powertrain: "ELECTRIC" as const,
      quantity: 5,
      priority: "NORMAL" as const,
      status: "DISPATCHED" as const,
      plannedProductionDate: new Date("2026-03-01"),
      plannedProductionWeek: "2026-W10",
      plannedDeliveryDate: new Date("2026-05-05"),
      vin: "WVGZZZ789ZS001003",
      chassisNumber: "CH-2026-0100-C",
      productionOrderNo: "PO-2026-0030",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
    },
    {
      id: "lo-008",
      orderNumber: "LO-00008",
      customerName: "AsiaBus Holdings",
      customerType: "CUSTOMER" as const,
      country: "Singapore",
      market: "APAC",
      vehicleModel: "CityStar 9M",
      vehicleType: "MIDIBUS" as const,
      powertrain: "CNG" as const,
      quantity: 12,
      priority: "NORMAL" as const,
      status: "DELIVERED" as const,
      plannedProductionDate: new Date("2026-01-15"),
      plannedProductionWeek: "2026-W03",
      plannedDeliveryDate: new Date("2026-03-30"),
      vin: "WVGZZZ321ZS001504",
      chassisNumber: "CH-2026-0150-D",
      productionOrderNo: "PO-2026-0010",
    ...
    {
      id: "lo-009",
      orderNumber: "LO-00009",
      customerName: "Internal Fleet Ops",
      ...
      quantity: 3,
      priority: "LOW" as const,
      status: "COMMERCIAL_REVIEW" as const,
      requestedDeliveryDate: new Date("2026-12-01"),
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-qe",
    },
    {
      id: "lo-010",
      orderNumber: "LO-00010",
      customerName: "LateShip Logistics",
      customerType: "CUSTOMER" as const,
      country: "Poland",
      market: "EU",
      vehicleModel: "Hauler T18",
      ...
      productionOrderNo: "PO-2026-0055",
      companyId: oemEnterpriseCompany.id,
      createdById: "oem-enterprise-admin",
  ...
  for (const order of logisticOrders) {
    await prisma.plantLogisticOrder.upsert({
      where: { id: order.id },
      update: {},
      create: order,
    });
  ...
  const logisticEvents = [
    { id: "lo-ev-001", orderId: "lo-001", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "ORDER_CREATED" as const, fromStatus: null, toStatus: "DRAFT" as const, message: "Order created", createdAt: new Date("2026-05-12T09:00:00Z") },
    { id: "lo-ev-002", orderId: "lo-001", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "STATUS_CHANGED" as const, fromStatus: "DRAFT" as const, toStatus: "SUBMITTED" as const, message: "Status changed from Draft to Submitted", createdAt: new Date("2026-05-12T09:30:00Z") },
    { id: "lo-ev-003", orderId: "lo-002", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "ORDER_CREATED" as const, fromStatus: null, toStatus: "DRAFT" as const, message: "Order created", createdAt: new Date("2026-05-08T10:00:00Z") },
    { id: "lo-ev-004", orderId: "lo-002", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "STATUS_CHANGED" as const, fromStatus: "DRAFT" as const, toStatus: "SUBMITTED" as const, message: "Status changed from Draft to Submitted", createdAt: new Date("2026-05-08T10:15:00Z") },
    { id: "lo-ev-005", orderId: "lo-002", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "STATUS_CHANGED" as const, fromStatus: "SUBMITTED" as const, toStatus: "COMMERCIAL_REVIEW" as const, message: "Status changed from Submitted to Commercial Review", createdAt: new Date("2026-05-08T14:00:00Z") },
    { id: "lo-ev-006", orderId: "lo-002", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "STATUS_CHANGED" as const, fromStatus: "COMMERCIAL_REVIEW" as const, toStatus: "APPROVED" as const, message: "Status changed from Commercial Review to Approved", createdAt: new Date("2026-05-10T09:00:00Z") },
    { id: "lo-ev-007", orderId: "lo-004", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "PLANNING_UPDATED" as const, fromStatus: null, toStatus: null, message: "Production/delivery planning updated", createdAt: new Date("2026-05-15T08:00:00Z") },
    { id: "lo-ev-008", orderId: "lo-005", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-qe", eventType: "STATUS_CHANGED" as const, fromStatus: "IN_PRODUCTION" as const, toStatus: "QUALITY_HOLD" as const, message: "Quality hold — paint defect identified", createdAt: new Date("2026-05-10T11:00:00Z") },
    { id: "lo-ev-009", orderId: "lo-005", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-qe", eventType: "COMMENT_ADDED" as const, fromStatus: null, toStatus: null, message: "Root cause under investigation. Supplier notified.", createdAt: new Date("2026-05-11T09:00:00Z") },
    { id: "lo-ev-010", orderId: "lo-006", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "VIN_ASSIGNED" as const, fromStatus: null, toStatus: null, message: "VIN assigned: WVGZZZ456ZT000802", createdAt: new Date("2026-04-25T14:00:00Z") },
    { id: "lo-ev-011", orderId: "lo-008", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "STATUS_CHANGED" as const, fromStatus: "DISPATCHED" as const, toStatus: "DELIVERED" as const, message: "Status changed from Dispatched to Delivered", createdAt: new Date("2026-03-28T16:00:00Z") },
    { id: "lo-ev-012", orderId: "lo-010", companyId: oemEnterpriseCompany.id, actorId: "oem-enterprise-admin", eventType: "COMMENT_ADDED" as const, fromStatus: null, toStatus: null, message: "DELAYED — planned delivery was May 1, still in production. Customer notified.", createdAt: new Date("2026-05-05T10:00:00Z") },
  ];
