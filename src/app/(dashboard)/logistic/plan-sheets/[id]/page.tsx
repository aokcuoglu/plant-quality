...
export default async function PlanSheetDetailPage({
  ...
  const serializable = {
    ...
    allowedActions: {
      canSubmit: PLAN_SHEET_ALLOWED.submit(sheet.status),
      canApprove: PLAN_SHEET_ALLOWED.approve(sheet.status),
      canReject: PLAN_SHEET_ALLOWED.reject(sheet.status),
      canCancel: PLAN_SHEET_ALLOWED.cancel(sheet.status),
      canEditLines: PLAN_SHEET_ALLOWED.approve(sheet.status),
    },
