          ...
          {fd.attachments.length > 0 && (
            <div className="rounded-lg border bg-card">
              <div className="px-4 py-3 border-b border-border flex items-center justify-between">
                ...
                <Link href={`/oem/field/${id}/media`} className="text-xs text-emerald-500 hover:text-emerald-600">
                  Manage Media →
                </Link>
              </div>
          ...
          {fd.linkedDefectId && fd.linkedDefect && (
            <div className="rounded-lg border bg-emerald-500/10">
              ...
              <div className="px-4 py-3">
                <Link href={`/oem/defects/${fd.linkedDefect.id}`} className="text-sm text-emerald-400 hover:underline">
