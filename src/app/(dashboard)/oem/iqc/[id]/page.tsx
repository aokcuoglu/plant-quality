  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        <Link href="/oem/iqc" className="hover:text-foreground">IQC</Link>
        <span>/</span>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{report.partNumber} {report.partName ? `— ${report.partName}` : ""}</p>
        </div>
