...
import { getIqcStatusColor, getIqcResultColor, IQC_STATUS_LABELS, IQC_RESULT_LABELS } from "@/lib/iqc"

export default async function SupplierIqcPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Incoming Quality Control inspections for your company</p>
      </div>
      ...
      {reports.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-card p-12 text-center">
          ...
          <p className="mt-1 text-xs text-muted-foreground">Incoming quality inspection records will appear here</p>
        </div>
      ) : (
