          ...
          <DialogContent className="sm:max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="companyName" name="companyName" required placeholder="Acme Parts Inc." />
              </div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="adminName" name="adminName" required placeholder="John Smith" />
                </div>

                <div className="space-y-2 mt-3">
                  <Label htmlFor="adminEmail">Email</Label>
                  <Input id="adminEmail" name="adminEmail" type="email" required placeholder="john@acme.com" />
                </div>
